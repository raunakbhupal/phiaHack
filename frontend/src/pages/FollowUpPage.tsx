    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-4 py-12 bg-white">
      <div className="w-full max-w-lg">
        <div className="text-center mb-8">
          <div className="inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-phia-50 text-2xl mb-4">
            🤔
          </div>
          ...
          <p className="text-sm text-gray-400">
            Help us find even better gifts — or skip to dive right in.
          </p>
        </div>
        ...
        <div className="card px-5 py-3 mb-6 bg-gray-50">
          ...
          <p className="text-sm text-gray-500 italic line-clamp-2">"{description}"</p>
        </div>
